# ifndef IPIPELINE_SP_H
# define IPIPELINE_SP_H
...
namespace ns3 {
    ...
    private:
        ...
        // subtree is the number of subtrees of each scheduling node
        static const int subtree = 4;
        // END_THRESHOLD is the criterion to end the simulation
        static const int END_THRESHOLD = 2000000;
        ...
        queue<Operation> pop_list[N];
        queue<Operation> push_list[N];
        //Note: Here always prior pop (1)
        bool rr_flag[N];
        ...
        static int max_tree_size_t;
        static int max_tree_size_e[T];
        static int sch_num;
        ...
        void SendOperation(int list_id,bool is_push);
